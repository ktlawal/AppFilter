...
"@
    ...
    <details class="filtered screen-only">
      <summary>Suppressed applications ($($filtered.Count))</summary>
      <p class="why">These were on the old device and are left off because the new image already provides them, or they were pushed.</p>
$($sections -join "`n")
    </details>
"@ + "`n"
    }
